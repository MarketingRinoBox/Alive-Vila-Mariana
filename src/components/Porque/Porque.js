        ...
        <div className='porque'>
            <div className='porque-area'>
                <div className='porque-area-texto'>
                    ...
                    <p>Morar na Vila Mariana é mais do que um privilégio. É estar mais perto da cidade inteira e bem ao tudo o que é preciso para viver bem: serviços, escolas, saúde, lazer e trabalho.</p>
